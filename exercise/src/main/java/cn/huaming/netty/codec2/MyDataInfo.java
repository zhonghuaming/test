...
public final class MyDataInfo {
  ...
  private static final long serialVersionUID = 0L;
    ...
    private MyMessage(GeneratedMessageV3.Builder<?> builder) {
      super(builder);
    }
    private MyMessage() {
      dataType_ = 0;
    ...
    public static final class Builder extends
      ...
      // Construct using cn.huaming.netty.codec2.MyDataInfo.MyMessage.newBuilder()
      private Builder() {
      ...
      private SingleFieldBuilderV3<
        ...
        if (workerBuilder_ == null) {
          ...
          workerBuilder_ = new SingleFieldBuilderV3<
              Worker, Worker.Builder, WorkerOrBuilder>(
                  (Worker) dataBody_,
                  getParentForChildren(),
                  isClean());
    ...
    private static final Parser<MyMessage>
        PARSER = new AbstractParser<MyMessage>() {
      @Override
    ...
    public static Parser<MyMessage> parser() {
      return PARSER;
    }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      // Construct using cn.huaming.netty.codec2.MyDataInfo.Student.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final Parser<Student>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      // Construct using cn.huaming.netty.codec2.MyDataInfo.Worker.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final Parser<Worker>
        PARSER = new AbstractParser<Worker>() {
      @Override
